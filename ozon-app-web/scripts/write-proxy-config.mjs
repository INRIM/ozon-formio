...
function buildRuntimeConfig(localEnv, parentEnv, backendTarget, siteUrl, allowedOrigins, sessionCacheTtlMs) {
  return {
    ...
    applogourl: pickFirstString(
      process.env.applogourl,
      process.env.APP_LOGO_URL,
      process.env.appLogoUrl,
      process.env.logo,
      process.env.logo_img_url,
      localEnv.applogourl,
      localEnv.APP_LOGO_URL,
      localEnv.appLogoUrl,
      localEnv.logo,
      localEnv.logo_img_url,
      parentEnv.applogourl,
      parentEnv.APP_LOGO_URL,
      parentEnv.appLogoUrl,
      parentEnv.logo,
      parentEnv.logo_img_url,
      'https://www.inrim.it/sites/default/files/2022-04/logoinrimhp%20%281%29.svg'
    ),
